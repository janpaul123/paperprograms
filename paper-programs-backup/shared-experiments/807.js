...
(async () => {
  ...
  const onProgramAdded = ( paperProgramNumber, scratchpad, sharedData ) => {
    ...
    const uniqueSliderName = 'REPLACE_ME'; // e.g. voltageSlider

    const modelProperty = model.myNumberProperty; // Rename to the model Property you created
  ...
  const onProgramRemoved = ( paperProgramNumber, scratchpad, sharedData ) => {
    ...
    const slider = scratchpad[ 'REPLACE_ME' ]; // replace with uniqueSliderName string above
    if ( slider ) {
      slider.dispose();
      delete scratchpad[ 'REPLACE_ME' ]; // replace with uniqueSliderName string above
    }
  };
